...
![Intro](docs/images/ms-reports_intro.png "Intro")
# Table of Contents
  ...
  * [BackEnd](#backend)
    *  [reports](#backend_reports)
        * [Environment variables](#backend_reports_env_vars)
        * [Event Sourcing](#backend_reports_eventsourcing)
        * [CronJobs](#backend_reports_cronjobs)
...
│   ├── reports                     => Micro-BackEnd responsible for ...
...
Note: You may find the GraphQL schema [here](api/emi-gateway/graphql/reports/schema.gql)
...
## reports <a name="backend_reports"></a>
...


### Environment variables <a name="backend_reports_env_vars"></a>
...
```
#### Notes: 
  * ENV VARS for development are [here](backend/reports/.env)
  * ENV VARS for production are [here](deployment/gke/deployment-reports.yaml)

### Event Sourcing <a name="backend_reports_eventsourcing"></a>
...
### CronJobs <a name="backend_reports_cronjobs"></a>
...
### 1. clone this repo  
   ```git clone https://github.com/nebulae-pyxis/ms-reports.git```  
...
### 5. Compose FrontEnd
```
nebulae compose-ui development --shell-type=FUSE2_ANGULAR --shell-repo=https://github.com/nebulae-pyxis/emi --frontend-id=emi --output-dir=/FULL_PATH_TO_REPO/ms-reports/playground/emi  --setup-file=/FULL_PATH_TO_REPO/ms-reports/etc/mfe-setup.json
```

### 6. Compose the API emi-gateway
```
nebulae compose-api development --api-type=NEBULAE_GATEWAY --api-repo=https://github.com/nebulae-pyxis/emi-gateway --api-id=emi-gateway --output-dir=FULL_PATH_TO_REPO/ms-reports/playground/emi-gateway  --setup-file=FULL_PATH_TO_REPO/ms-reports/etc/mapi-setup.json
```
...
* set this key value to the **JWT_PUBLIC_KEY** atribute in the following files: *WORKING_FOLDER*/ms-reports/backend/reports/.env   *WORKING_FOLDER*/ms-reports/playground/emi-gateway/.env  
